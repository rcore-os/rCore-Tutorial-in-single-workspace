...
impl Process {
    /// 获取进程 sepc（用户态入口/当前 PC）。
    pub fn sepc(&self) -> usize {
        self.context.context.pc()
    }
    ...
    pub fn syscall_id_raw(&self) -> usize {
        self.context.context.a(7)
    }

    /// 获取 a0 寄存器。
    pub fn a0(&self) -> usize {
        self.context.context.a(0)
    }
    ...
    pub fn new(elf: ElfFile, proc_id: usize) -> Option<Self> {
        ...
        for program in elf.program_iter() {
            ...
            let flags_str = unsafe { core::str::from_utf8_unchecked(&flags) };
            crate::lec5_lab4::emit_elf_segment(proc_id, seg_idx, off_mem, end_mem, flags_str);
            seg_idx += 1;
        ...
        *context.sp_mut() = 1 << 38;
        ...
        crate::lec5_lab4::emit_process_created(proc_id, entry, satp, heap_bottom);
        crate::lec5_lab4::emit_page_table_summary(proc_id, &address_space);
