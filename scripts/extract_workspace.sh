...
ARCHIVE_PATH="${ROOT_DIR}/bundle/rCore-Tutorial-in-single-workspace.tar.gz"
...
echo "  ${OUTPUT_DIR}/rCore-Tutorial-in-single-workspace"
echo
echo "Next steps:"
echo "  cd \"${OUTPUT_DIR}/rCore-Tutorial-in-single-workspace\""
